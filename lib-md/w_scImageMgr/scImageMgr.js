...
scImageMgr.fStrings = ["سابق","صورة سابقة  (سهم يسار)",
	/*02*/               "موالي","صورة موالية (سهم يمين)",
	/*04*/               "اغلق","إغلاق عرض الشرائح (Échap)",
	/*06*/               "أطلق","أطلق عرض الشرائح (P)",
	/*08*/               "قم بتوقيف","قم بتوقيف عرض الشرائح (p)",
	/*10*/               "هذه الصفحة في طور التحميل، المرجوالانتظار.","",
	/*12*/               "سابق","صورة سابقة",
	/*14*/               "موالي","صورة موالية",
	/*16*/               "أطلق","أطلق عملية التنشيط",
	/*18*/               "قم بتوقيف","قم بتوقيف عملية التنشيط",
	/*20*/               "بداية","اذهب إلى بداية عملية التنشيط",
	/*22*/               "نهاية","اذهب إلى نهاية عملية التنشيط",
	/*24*/               "سرعة","غير سرعة عملية التنشيط",
	/*26*/               "صورة","اكشف عرض الشرائح بداية من :",
	/*28*/               "حلقة","أنجز بحلقة مستمرة",
	/*30*/               "اغلق","إغلاق التكبير (Échap)",
	/*32*/               "كبر على هذه الصورة",""];
/** scImageMgr.init. */
...
scImageMgr.xUdtSs = function(pAlbFra,pNewAnc) {
	...
	if (pAlbFra.fSsBtnPrv) {
		...
		if (pAlbFra.fSsHasPrv) {
			pAlbFra.fSsBtnPrv.removeAttribute("aria-disabled");
			pAlbFra.fSsBtnPrv.removeAttribute("tabindex");
		}
		else {
			pAlbFra.fSsBtnPrv.setAttribute("aria-disabled", "true");
			pAlbFra.fSsBtnPrv.setAttribute("tabindex", "-1");
		}
	}
	if (pAlbFra.fSsBtnNxt) {
		...
		if (pAlbFra.fSsHasNxt) {
			pAlbFra.fSsBtnNxt.removeAttribute("aria-disabled");
			pAlbFra.fSsBtnNxt.removeAttribute("tabindex");
		}
		else {
			pAlbFra.fSsBtnNxt.setAttribute("aria-disabled", "true");
			pAlbFra.fSsBtnNxt.setAttribute("tabindex", "-1");
		}
	}
...
scImageMgr.xAddBtn = function(pParent,pObj,pType,pName,pCapt,pTitle,pNoCmd){
	...
	vBtn.setAttribute("aria-label",pTitle);
